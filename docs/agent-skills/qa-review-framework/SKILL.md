...
6. Стенды: `multistack_ci` (pipeline) / `multistack_prod`; stage-файла может не быть — это находка, не баг кода. URL не в тестах. Деструктивные тесты без ограничения стенда — must.
