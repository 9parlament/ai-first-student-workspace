...
| JaCoCo | % строк/веток **unit** backend | `backend-java-spring`: LINE+BRANCH **1.0** (CI job `unit-tests`) |
| Vitest coverage | % JS/TS component | job `component-tests` (`npm test -- --coverage`) |
