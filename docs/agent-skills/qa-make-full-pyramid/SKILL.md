...
| ui | `…/tests/ui/HeaderTests.java` / `HomeLayoutTests.java` | `cd tests/java/tests-java-gradle-junit5-allure3-selenide && ./gradlew test -Denv=mock -DincludeTags=ui -DexcludeTags=screenshot` |
| e2e | `…/tests/e2e/LoginTests.java` | `cd tests/java/tests-java-gradle-junit5-allure3-selenide && ./gradlew test -Denv=ci -DincludeTags=e2e -DexcludeTags=screenshot` |
